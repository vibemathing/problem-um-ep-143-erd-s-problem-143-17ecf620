...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-143-erd-s-problem-143-17ecf620-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-143"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-143-erd-s-problem-143-17ecf620-v1",
      "problem_contract_sha256": "b5fd545e16979c4ea95d192dcaf24bd48387944e9b0d421cb56b2fa788371a37",
      "problem_id": "problem:um-ep-143-erd-s-problem-143-17ecf620",
      "route_id": "route:um-ep-143-erd-s-problem-143-17ecf620-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-143-erd-s-problem-143-17ecf620-source-fidelity-01",
      "graph_id": "graph:um-ep-143-erd-s-problem-143-17ecf620-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-143-erd-s-problem-143-17ecf620-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-143-erd-s-problem-143-17ecf620-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A\\subset (1,\\infty)$ be a countably infinite set such that for all $x eq y\\in A$ and integers $k\\geq 1$ we have $ \\lvert kx -y\\rvert \\geq 1. $ Does this imply that $A$ is sparse? In particular, does this imply that $ \\sum_{x\\in A}\\frac{1}{x\\log x}<\\infty $ or $ \\sum_{\\substack{x <n\\\\ x\\in A}}\\frac{1}{x}=o(\\log n)? $"
          },
          "statement_sha256": "88bcd3faafc58d3b70dea1560c78e87a933e060162373d93293298098dda0630"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-143-erd-s-problem-143-17ecf620-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-143-erd-s-problem-143-17ecf620-root",
      "route_id": "route:um-ep-143-erd-s-problem-143-17ecf620-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-143-948e45af051e",
        "url": "https://www.unsolvedmath.com/problems/EP-143"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
